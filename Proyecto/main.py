...
def RegistrarVehiculo():
        if request.method == 'GET':
            ...
            return render_template('RegistrarVehiculo.html', listaClientes = clientes)
            ...
            return("se registró el vehiculo correctamente")
#ConsultarVehiculo 
...
def RegistrarServicio():
     if session['logged'] == True:
         if request.method == 'GET':
            ...
            return"se registró el servicio correctamente"
...
def RegistrarNota():
        ...
        if request.method == 'POST':
             ...
             return"se registró la nota correctamente"
        else:
            return render_template('Error.html')
